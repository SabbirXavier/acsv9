...
import { GraduationCap, MapPin, CalendarCheck, Phone, Calendar, ArrowRight, Radio, Brain, Zap, Star, CheckCircle2, Circle, Download, Play, Image as ImageIcon, FileText, Mic, ExternalLink, Moon, Sun, Clock, Instagram } from 'lucide-react';
  ...
  return (
    <div className="space-y-5">
      ...
      <motion.header 
        ...
        className="flex flex-col items-center justify-center text-center relative z-10 p-4 pt-12"
      >
        <div 
        ...
        <div className="flex flex-col sm:flex-row items-center justify-center gap-3 w-full max-w-2xl mx-auto">
          <button 
            ...
            className="flex-1 inline-flex items-center justify-center gap-2.5 bg-gradient-to-br from-[var(--primary)] to-[var(--secondary)] text-white w-full py-3.5 px-6 rounded-2xl font-bold shadow-lg transition-all duration-200 border border-white/20 text-lg hover:scale-105"
          >
            <ArrowRight size={24} />
            Enroll Now
          </button>
      ...
      {activeRadars.length > 0 && (
        <motion.div 
          ...
          viewport={{ once: true, margin: "-50px" }}
          transition={{ duration: 0.6, ease: "easeOut" }}
          className="glass-card !p-4 bg-gradient-to-r from-red-500/5 to-transparent border-red-500/20"
        >
              ...
              return (
                <div key={radar.id} className="bg-white/5 border border-[var(--border-color)] p-4 rounded-xl space-y-4 relative overflow-hidden group">
                  ...
                  {radar.instagramProfile && (
                    <div className="relative z-10 pt-2 mt-1">
      ...
      <motion.div 
        ...
        viewport={{ once: true, margin: "-50px" }}
        transition={{ duration: 0.6, ease: "easeOut" }}
        className="glass-card relative z-20 pt-8"
      >
